package com.media.image.compress;
...
public class ImageCompress implements Handler.Callback {
  ...
  private static final String DEFAULT_DISK_CACHE_DIR = "img_compress_disk_cache";
   ...
   * use to store retrieved com.media and thumbnails.
   *
   * @param context   A context.
