...
public class UIWebViewClient extends WebViewClient {
    ...
    public UIWebViewClient(boolean needDispatchSafeAreaInset, boolean disableVideoFullscreenBtnAlways) {
        mNeedDispatchSafeAreaInset = needDispatchSafeAreaInset;
        mDisableVideoFullscreenBtnAlways = disableVideoFullscreenBtnAlways;
    }


    public void setNeedDispatchSafeAreaInset(UIWebView webView) {
    ...
    public void onPageFinished(final WebView view, String url) {
        ...
        if (mNeedDispatchSafeAreaInset && view instanceof UIWebView) {
            dispatchFullscreenRequestAction((UIWebView) view);
        }
    }
    ...
    private String getJsCodeForDisableVideoFullscreenBtn() {
        return "(function(){\n" +
                ...
                "   style.type = 'text/css';" +
                "   style.innerHTML = 'video::-webkit-com.media-controls-fullscreen-button{display: none !important;}'\n" +
    ...
    private void dispatchFullscreenRequestAction(final UIWebView webView) {
