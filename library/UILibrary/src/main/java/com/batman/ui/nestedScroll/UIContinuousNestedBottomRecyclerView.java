...
public class UIContinuousNestedBottomRecyclerView extends RecyclerView
        implements IUIContinuousNestedBottomView {

    public static final String KEY_SCROLL_INFO_POSITION = "@ui_scroll_info_bottom_rv_pos";
    public static final String KEY_SCROLL_INFO_OFFSET = "@ui_scroll_info_bottom_rv_offset";
                ...
                if (mOnScrollNotifier != null) {
                    if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                        mOnScrollNotifier.onScrollStateChange(recyclerView,
                                IUIContinuousNestedScrollCommon.SCROLL_STATE_IDLE);
                    } else if (newState == RecyclerView.SCROLL_STATE_SETTLING) {
                        mOnScrollNotifier.onScrollStateChange(recyclerView,
                                IUIContinuousNestedScrollCommon.SCROLL_STATE_SETTLING);
                    } else if (newState == RecyclerView.SCROLL_STATE_DRAGGING) {
                        mOnScrollNotifier.onScrollStateChange(recyclerView,
                                IUIContinuousNestedScrollCommon.SCROLL_STATE_DRAGGING);
                    }
                }
            }
