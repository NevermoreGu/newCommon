...
package com.batman.ui.widget.grouplist;
 ...
 * @date 2015-1-8
 */
public class UICommonListItemView extends UIConstraintLayout {
    ...
    @Retention(RetentionPolicy.SOURCE)
    public @interface UICommonListItemTipPosition {
    }
    ...
    protected void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final int initTitleColor = array.getColor(R.styleable.UICommonListItemView_ui_common_list_title_color, 0);
        final int initDetailColor = array.getColor(R.styleable.UICommonListItemView_ui_common_list_detail_color, 0);
        array.recycle();
    ...
    public void setTipPosition(@UICommonListItemTipPosition int tipPosition) {
    ...
    private void checkDetailLeftMargin() {
        ...
        if (mOrientation == VERTICAL) {
            ...
            if (mNewTipView.getVisibility() == View.GONE || mTipPosition == TIP_POSITION_LEFT) {
                detailLp.leftMargin = UIResHelper.getAttrDimen(
                        getContext(), R.attr.ui_common_list_item_detail_h_margin_with_title);
            } else {
                detailLp.leftMargin = UIResHelper.getAttrDimen(
                        getContext(), R.attr.ui_common_list_item_detail_h_margin_with_title_large);
            }
        }
    }
    ...
    public void setOrientation(@UICommonListItemOrientation int orientation) {
        ...
        if (orientation == VERTICAL) {
            mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    UIResHelper.getAttrDimen(getContext(), R.attr.ui_common_list_item_title_v_text_size));
            mDetailTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    UIResHelper.getAttrDimen(getContext(), R.attr.ui_common_list_item_detail_v_text_size));
            ...
            detailLp.leftMargin = 0;
            detailLp.topMargin = UIResHelper.getAttrDimen(
                    getContext(), R.attr.ui_common_list_item_detail_v_margin_with_title);
        } else {
            mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    UIResHelper.getAttrDimen(getContext(), R.attr.ui_common_list_item_title_h_text_size));
            mDetailTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    UIResHelper.getAttrDimen(getContext(), R.attr.ui_common_list_item_detail_h_text_size));
    ...
    private ImageView getAccessoryImageView() {
        ...
        builder.tintColor(R.attr.ui_skin_support_common_list_chevron_color);
        UISkinHelper.setSkinValue(resultImageView, builder);
    ...
    public void setSkinConfig(SkinConfig skinConfig) {
        ...
        UISkinHelper.setSkinValue(mImageView, builder);
    ...
    public static class SkinConfig {
        ...
        public int iconTintColorRes = R.attr.ui_skin_support_common_list_icon_tint_color;
        public int iconSrcRes = 0;
        public int titleTextColorRes = R.attr.ui_skin_support_common_list_title_color;
        public int detailTextColorRes = R.attr.ui_skin_support_common_list_detail_color;
        public int newTipSrcRes = R.attr.ui_skin_support_common_list_new_drawable;
        public int tipDotColorRes = R.attr.ui_skin_support_common_list_red_point_tint_color;
    }
}
