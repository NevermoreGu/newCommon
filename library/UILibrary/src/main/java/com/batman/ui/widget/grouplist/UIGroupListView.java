...
public class UIGroupListView extends LinearLayout {
    ...
    public UICommonListItemView createItemView(@Nullable Drawable imageDrawable, CharSequence titleText, String detailText, int orientation, int accessoryType, int height) {
    ...
    public UICommonListItemView createItemView(@Nullable Drawable imageDrawable, CharSequence titleText, String detailText, int orientation, int accessoryType) {
        int height;
    ...
    public static class Section {
        ...
        private int mSeparatorColorAttr = R.attr.ui_skin_support_common_list_separator_color;
        ...
        private int mBgAttr = R.attr.ui_skin_support_s_common_list_bg;
        ...
        public void addTo(UIGroupListView groupListView) {
            ...
            int separatorColor = UIResHelper.getAttrColor(groupListView.getContext(), mSeparatorColorAttr);
            for (int i = 0; i < itemViewCount; i++) {
                UICommonListItemView itemView = mItemViews.get(i);
                Drawable bg = UISkinHelper.getSkinDrawable(groupListView, mBgAttr);
                UIViewHelper.setBackgroundKeepingPadding(itemView, bg == null ? null : bg.mutate());
                UISkinHelper.setSkinValue(itemView, skin);
