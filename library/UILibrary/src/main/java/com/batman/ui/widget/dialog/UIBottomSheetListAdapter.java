...
public class UIBottomSheetListAdapter extends RecyclerView.Adapter<UIBottomSheetListAdapter.VH> {
    ...
    private List<UIBottomSheetListItemModel> mData = new ArrayList<>();
    private final boolean mNeedMark;
    private final boolean mGravityCenter;
    private int mCheckedIndex = -1;
    private OnItemClickListener mOnItemClickListener;

    public UIBottomSheetListAdapter(boolean needMark, boolean gravityCenter){
        mNeedMark = needMark;
    ...
    public void setData(@Nullable View headerView,
                        ...
                        List<UIBottomSheetListItemModel> data) {
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final VH vh = new VH(new UIBottomSheetListItemView(
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        UIBottomSheetListItemModel itemModel = mData.get(position);
        UIBottomSheetListItemView itemView = (UIBottomSheetListItemView) holder.itemView;
    ...
    interface OnItemClickListener {
        void onClick(VH vh, int dataPos, UIBottomSheetListItemModel model);
    }
}
