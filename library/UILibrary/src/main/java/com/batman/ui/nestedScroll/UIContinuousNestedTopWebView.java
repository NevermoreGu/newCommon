...
import com.batman.ui.widget.webview.UIWebView;

public class UIContinuousNestedTopWebView extends UIWebView implements IUIContinuousNestedTopView {

    public static final String KEY_SCROLL_INFO = "@ui_scroll_info_top_webview";

    private OnScrollNotifier mScrollNotifier;

    public UIContinuousNestedTopWebView(Context context) {
        super(context);
        init();
    }

    public UIContinuousNestedTopWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public UIContinuousNestedTopWebView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void restoreScrollInfo(@NonNull Bundle bundle) {
        int scrollY = UIDisplayHelper.px2dp(getContext(),
