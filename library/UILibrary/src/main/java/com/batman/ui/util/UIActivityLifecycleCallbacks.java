...
public abstract class UIActivityLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {

    private final Activity mTargetActivity;

    public UIActivityLifecycleCallbacks(Activity targetActivity) {
