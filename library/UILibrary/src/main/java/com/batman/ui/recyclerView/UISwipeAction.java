...
public class UISwipeAction {
    ...
    private UISwipeAction(ActionBuilder builder) {
    ...
    public static class ActionBuilder {
        ...
        TimeInterpolator mSwipeMoveInterpolator = UIInterpolatorStaticHolder.ACCELERATE_INTERPOLATOR;
        int mSwipePxPerMS = 2;
        ...
        public UISwipeAction build() {
            return new UISwipeAction(this);
        }
    }
}
