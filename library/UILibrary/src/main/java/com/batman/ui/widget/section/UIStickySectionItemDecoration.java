...
public class UIStickySectionItemDecoration<VH extends UIStickySectionAdapter.ViewHolder>
    ...
    public UIStickySectionItemDecoration(ViewGroup sectionContainer, @NonNull Callback<VH> callback) {
        mCallback = callback;
    ...
    public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerView parent,
        ...
        if (itemType == UIStickySectionAdapter.ITEM_TYPE_UNKNOWN) {
            setHeaderVisibility(false);
            return;
        }
    ...
    public interface Callback<ViewHolder extends UIStickySectionAdapter.ViewHolder> {
        /**
