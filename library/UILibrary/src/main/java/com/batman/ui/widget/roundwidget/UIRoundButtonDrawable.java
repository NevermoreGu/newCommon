...
public class UIRoundButtonDrawable extends GradientDrawable {
    ...
    public static UIRoundButtonDrawable fromAttributeSet(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.UIRoundButton, defStyleAttr, 0);
