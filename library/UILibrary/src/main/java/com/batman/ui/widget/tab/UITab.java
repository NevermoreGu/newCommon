...
public class UITab {
    ...
    public int getNormalColor(@NonNull View skinFollowView) {
        ...
        return UISkinHelper.getSkinColor(skinFollowView, normalColorAttr);
    }
    ...
    public int getSelectColor(@NonNull View skinFollowView) {
        ...
        return UISkinHelper.getSkinColor(skinFollowView, selectedColorAttr);
    }
    ...
    public int getNormalTabIconWidth() {
        if (normalTabIconWidth == UITabIcon.TAB_ICON_INTRINSIC && tabIcon != null) {
    ...
    public int getNormalTabIconHeight() {
        if (normalTabIconHeight == UITabIcon.TAB_ICON_INTRINSIC && tabIcon != null) {
            return tabIcon.getIntrinsicWidth();
        }
