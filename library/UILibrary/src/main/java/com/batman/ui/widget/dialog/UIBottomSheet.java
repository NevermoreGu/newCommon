...
import static com.batman.ui.layout.IUILayout.HIDE_RADIUS_SIDE_BOTTOM;

/**
 * UIBottomSheet 在 {@link Dialog} 的基础上重新定制了 {@link #show()} 和 {@link #hide()} 时的动画效果, 使 {@link Dialog} 在界面底部升起和降下。
 * <p>
 * 提供了以下两种面板样式:
 * <ul>
 ...
 * </p>
 */
public class UIBottomSheet extends UIBaseDialog {
    private static final String TAG = "UIBottomSheet";
    private UIBottomSheetRootLayout mRootView;
    private OnBottomSheetShowListener mOnBottomSheetShowListener;
    private UIBottomSheetBehavior<UIBottomSheetRootLayout> mBehavior;
    private boolean mAnimateToCancel = false;
    private boolean mAnimateToDismiss = false;


    public UIBottomSheet(Context context) {
        this(context, R.style.UI_BottomSheet);
    }

    public UIBottomSheet(Context context, int style) {
        super(context, style);
        ViewGroup container = (ViewGroup) getLayoutInflater().inflate(R.layout.ui_bottom_sheet_dialog, null);
    ...
    public UIBottomSheetRootLayout getRootView() {
        return mRootView;
    }

    public UIBottomSheetBehavior<UIBottomSheetRootLayout> getBehavior() {
        return mBehavior;
    }
    ...
    public void setContentView(View view, ViewGroup.LayoutParams params) {
        throw new IllegalStateException(
                "Use addContentView(View, UIPriorityLinearLayout.LayoutParams) for replacement");
    }
    ...
    public void addContentView(View view, UIPriorityLinearLayout.LayoutParams layoutParams) {
    ...
    /**
     * 生成列表类型的 {@link UIBottomSheet} 对话框。
     */
    public static class BottomListSheetBuilder extends UIBottomSheetBaseBuilder<BottomListSheetBuilder> {


        private List<UIBottomSheetListItemModel> mItems;
        ...
        public BottomListSheetBuilder addItem(UIBottomSheetListItemModel itemModel) {
        ...
        public BottomListSheetBuilder addItem(String textAndTag) {
            mItems.add(new UIBottomSheetListItemModel(textAndTag, textAndTag));
            return this;
        }
        ...
        public BottomListSheetBuilder addItem(Drawable image, String textAndTag) {
            mItems.add(new UIBottomSheetListItemModel(textAndTag, textAndTag).image(image));
            return this;
        }
        ...
        public BottomListSheetBuilder addItem(String text, String tag) {
            mItems.add(new UIBottomSheetListItemModel(text, tag));
            return this;
        }
        ...
        public BottomListSheetBuilder addItem(int imageRes, String text, String tag) {
            mItems.add(new UIBottomSheetListItemModel(text, tag).image(imageRes));
            return this;
        }
        ...
        public BottomListSheetBuilder addItem(int imageRes, String text, String tag, boolean hasRedPoint) {
            mItems.add(new UIBottomSheetListItemModel(text, tag).image(imageRes).redPoint(hasRedPoint));
            return this;
        }
        ...
        @Nullable
        @Override
        protected View onCreateContentView(@NonNull final UIBottomSheet bottomSheet,
                                           @NonNull UIBottomSheetRootLayout rootLayout,
                                           @NonNull Context context) {
            RecyclerView recyclerView = new RecyclerView(context);
            recyclerView.setOverScrollMode(RecyclerView.OVER_SCROLL_NEVER);
            UIBottomSheetListAdapter adapter = new UIBottomSheetListAdapter(
            ...
            recyclerView.addItemDecoration(new UIBottomSheetListItemDecoration(context));
            ...
            adapter.setOnItemClickListener(new UIBottomSheetListAdapter.OnItemClickListener() {
                @Override
                public void onClick(UIBottomSheetListAdapter.VH vh, int dataPos, UIBottomSheetListItemModel model) {
        ...
        public interface OnSheetItemClickListener {
            void onClick(UIBottomSheet dialog, View itemView, int position, String tag);
        }
    }

    /**
     * 生成宫格类型的 {@link UIBottomSheet} 对话框。
     */
    public static class BottomGridSheetBuilder extends UIBottomSheetBaseBuilder<BottomGridSheetBuilder>
        ...
        public interface ItemViewFactory {
            UIBottomSheetGridItemView create(UIBottomSheet bottomSheet, UIBottomSheetGridItemModel model);
        }

        public static class DefaultItemViewFactory implements ItemViewFactory {

            @Override
            public UIBottomSheetGridItemView create(@NonNull UIBottomSheet bottomSheet, @NonNull UIBottomSheetGridItemModel model) {
                UIBottomSheetGridItemView itemView = new UIBottomSheetGridItemView(bottomSheet.getContext());
                itemView.render(model);
                return itemView;
            }
        }

        private ArrayList<UIBottomSheetGridItemModel> mFirstLineItems;
        private ArrayList<UIBottomSheetGridItemModel> mSecondLineItems;
        ...
        public BottomGridSheetBuilder addItem(@NonNull UIBottomSheetGridItemModel model, @Style int style) {
            switch (style) {
                case FIRST_LINE:
        ...
        public BottomGridSheetBuilder addItem(int imageRes, CharSequence text, Object tag,
            ...
            return addItem(new UIBottomSheetGridItemModel(text, tag)
                    .image(imageRes)
        ...
        @Nullable
        @Override
        protected View onCreateContentView(@NonNull UIBottomSheet bottomSheet,
                                           @NonNull UIBottomSheetRootLayout rootLayout,
                                           @NonNull Context context) {
            ...
            if (!mFirstLineItems.isEmpty()) {
                ...
                for (UIBottomSheetGridItemModel model : mFirstLineItems) {
                    UIBottomSheetGridItemView itemView = mItemViewFactory.create(bottomSheet, model);
            ...
            if (!mSecondLineItems.isEmpty()) {
                ...
                for (UIBottomSheetGridItemModel model : mSecondLineItems) {
                    UIBottomSheetGridItemView itemView = mItemViewFactory.create(bottomSheet, model);
                    itemView.setOnClickListener(this);
            ...
            return new UIBottomSheetGridLineLayout(mDialog, firstLines, secondLines);
        }

        public interface OnSheetItemClickListener {
            void onClick(UIBottomSheet dialog, View itemView);
        }
