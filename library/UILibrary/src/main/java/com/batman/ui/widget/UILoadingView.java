 ...
 * @date 2016-09-21
 */
public class UILoadingView extends View implements IUISkinDefaultAttrProvider {
    ...
    static {
        ...
        sDefaultAttrs.put(UISkinValueBuilder.TINT_COLOR, R.attr.ui_skin_support_loading_color);
    }
