...
public abstract class UISkinRuleDrawableHandler implements IUISkinRuleHandler {
    @Override
    public final void handle(@NonNull UISkinManager skinManager,
                             @NonNull View view,
                             @NonNull Resources.Theme theme,
                             @NonNull String name, int attr) {
        handle(view, name, UIResHelper.getAttrDrawable(view.getContext(), theme, attr));
    }
