...
public class UIKeyboardHelper {
    ...
    private static final String TAG = "UIKeyboardHelper";
    ...
    public static void setVisibilityEventListener(final Activity activity,
        ...
        final View activityRoot = UIViewHelper.getActivityRoot(activity);
        ...
        final ViewTreeObserver.OnGlobalLayoutListener layoutListener =
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    private final int visibleThreshold = Math.round(
                            UIDisplayHelper.dp2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
        ...
        activity.getApplication()
                .registerActivityLifecycleCallbacks(new UIActivityLifecycleCallbacks(activity) {
                    @Override
    ...
    public static boolean isKeyboardVisible(Activity activity) {
        ...
        View activityRoot = UIViewHelper.getActivityRoot(activity);
        int visibleThreshold =
                Math.round(UIDisplayHelper.dp2px(activity, KEYBOARD_VISIBLE_THRESHOLD_DP));
