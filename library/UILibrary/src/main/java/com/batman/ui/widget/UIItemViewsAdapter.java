 ...
 * 复用已存在的 {@link View}。
 * UI 用于 {@link com.batman.ui.widget.tab.UITabSegment} 中 {@link com.batman.ui.widget.tab.UITab} 与数据的适配。
 *
 * @author cginechen
 * @date 2016-11-27
 */

public abstract class UIItemViewsAdapter<T, V extends View> {
    ...
    public UIItemViewsAdapter(ViewGroup parentView) {
    ...
    public void detach(int count) {
        ...
        while (childCount > 0 && count > 0) {
            ...
            Object notCacheTag = view.getTag(R.id.ui_view_can_not_cache_tag);
    ...
    public UIItemViewsAdapter<T, V> addItem(T item) {
        mItemData.add(item);
        return this;
    }
