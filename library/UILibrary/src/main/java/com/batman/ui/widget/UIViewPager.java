...
public class UIViewPager extends ViewPager implements IWindowInsetLayout {
    private static final int DEFAULT_INFINITE_RATIO = 100;

    private boolean mIsSwipeable = true;
    private boolean mIsInMeasure = false;
    private UIWindowInsetHelper mUIWindowInsetHelper;
    ...
    public void setAdapter(PagerAdapter adapter) {
        if (adapter instanceof UIPagerAdapter) {
            super.setAdapter(new WrapperPagerAdapter((UIPagerAdapter) adapter));
        } else {
    ...
    class WrapperPagerAdapter extends PagerAdapter {
        ...
        public WrapperPagerAdapter(UIPagerAdapter adapter) {
            mAdapter = adapter;
        }
