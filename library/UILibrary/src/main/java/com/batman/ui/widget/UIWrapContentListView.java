...
public class UIWrapContentListView extends ListView {
    private int mMaxHeight = Integer.MAX_VALUE >> 2;

    public UIWrapContentListView(Context context){
        super(context);
    }

    public UIWrapContentListView(Context context, int maxHeight) {
        super(context);
        mMaxHeight = maxHeight;
    }

    public UIWrapContentListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public UIWrapContentListView(Context context, AttributeSet attrs, int defStyleAttr) {
