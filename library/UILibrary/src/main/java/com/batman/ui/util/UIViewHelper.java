...
public class UIViewHelper {
     ...
     * <p>相关方法 {@link #slideOut(View, int, Animation.AnimationListener, boolean, UIDirection)}</p>
     *
     * @param view            做动画的 View
     * @param duration        动画时长(毫秒)
     * @param listener        动画回调
    ...
    public static
    @Nullable
    TranslateAnimation slideIn(final View view, int duration, final Animation.AnimationListener listener, boolean isNeedAnimation, UIDirection direction) {
        if (view == null) {
            return null;
        }
        if (isNeedAnimation) {
     ...
     * <p>相关方法 {@link #slideIn(View, int, Animation.AnimationListener, boolean, UIDirection)}</p>
     *
     * @param view            做动画的 View
     * @param duration        动画时长(毫秒)
     * @param listener        动画回调
    ...
    public static
    @Nullable
    TranslateAnimation slideOut(final View view, int duration, final Animation.AnimationListener listener, boolean isNeedAnimation, UIDirection direction) {
        if (view == null) {
            return null;
        }
        if (isNeedAnimation) {
    ...
    /**
     * requestDisallowInterceptTouchEvent 的安全方法。存在它的原因是 UIPullRefreshLayout 会拦截这个事件
     *
     * @param view
     * @param value
     */
    public static void safeRequestDisallowInterceptTouchEvent(@NonNull View view, boolean value) {
        ...
        if (viewParent != null) {
            ...
            while (layout != null) {
                if (layout instanceof UIPullRefreshLayout) {
                    ((UIPullRefreshLayout) layout).openSafeDisallowInterceptTouchEvent();
                }
