...
public class UIAlwaysFollowOffsetCalculator implements UIPullLayout.ActionViewOffsetCalculator {

    @Override
    public int calculateOffset(UIPullLayout.PullAction pullAction, int targetOffset) {
