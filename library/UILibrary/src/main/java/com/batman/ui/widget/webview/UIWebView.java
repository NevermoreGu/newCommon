...
import com.batman.ui.util.UINotchHelper;
...
public class UIWebView extends WebView implements IWindowInsetLayout {
    ...
    private UIWindowInsetHelper mWindowInsetHelper;
    ...
    private void init() {
        ...
        mWindowInsetHelper = new UIWindowInsetHelper(this, this);
    }
    ...
    public void setWebViewClient(WebViewClient client) {
        if (client != null && !(client instanceof UIWebViewClient)) {
            throw new IllegalArgumentException("must use the instance of UIWebViewClient");
        }
    ...
    public boolean applySystemWindowInsets21(Object insets) {
        ...
        float density = UIDisplayHelper.getDensity(getContext());
