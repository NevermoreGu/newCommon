 ...
 * offsets.
 */
public final class UIViewOffsetHelper {
    ...
    public UIViewOffsetHelper(View view) {
        mView = view;
    }
    ...
    /**
     * Set the top and bottom offset for this {@link UIViewOffsetHelper}'s view.
     *
    ...
    /**
     * Set the left and right offset for this {@link UIViewOffsetHelper}'s view.
     *
     * @param offset the offset in px.
     * @return true if the offset has changed
     */
