...
import static com.batman.ui.recyclerView.UIRVItemSwipeAction.SWIPE_DOWN;
import static com.batman.ui.recyclerView.UIRVItemSwipeAction.SWIPE_LEFT;
import static com.batman.ui.recyclerView.UIRVItemSwipeAction.SWIPE_NONE;
import static com.batman.ui.recyclerView.UIRVItemSwipeAction.SWIPE_RIGHT;
import static com.batman.ui.recyclerView.UIRVItemSwipeAction.SWIPE_UP;

public class UISwipeViewHolder extends RecyclerView.ViewHolder {
    ...
    public UISwipeViewHolder(@NonNull View itemView) {
        super(itemView);
    }

    public void addSwipeAction(UISwipeAction action) {
    ...
    void setup(int swipeDirection, boolean swipeDeleteIfOnlyOneAction) {
        ...
        for (ActionWrapper wrapper : mSwipeActions) {
            UISwipeAction action = wrapper.action;
    ...
    UISwipeAction checkUp(float x, float y, int touchSlop) {
    ...
    static class ActionWrapper {
        ...
        public ActionWrapper(@NonNull UISwipeAction action, @NonNull Callback callback) {
            this.action = action;
        ...
        private void startAnimator(float curLeft, float curTop, float targetLeft, float targetTop, int direction) {
            UIViewHelper.clearValueAnimator(animator);
            if (isVer(direction)) {
