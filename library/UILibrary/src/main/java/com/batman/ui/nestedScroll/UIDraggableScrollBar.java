...
public class UIDraggableScrollBar extends View {
    ...
    private int mAdjustDistanceProtection = UIDisplayHelper.dp2px(getContext(), 20);
    private int mAdjustMaxDistanceOnce = UIDisplayHelper.dp2px(getContext(), 4);
    private boolean enableFadeInAndOut = true;

    public UIDraggableScrollBar(Context context) {
        this(context, (AttributeSet) null);
    }

    public UIDraggableScrollBar(Context context, @NonNull Drawable dragDrawable) {
        this(context, (AttributeSet) null);
        mDragDrawable = dragDrawable.mutate();
    }

    public UIDraggableScrollBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void awakenScrollBar() {
        if (mDragDrawable == null) {
            mDragDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ui_icon_scroll_bar);
        }
