 ...
 * shown radius image in view, is different to {@link UIRadiusImageView2}
 *
 * @author cginechen
 * @date 2015-07-09
 */
public class UIRadiusImageView extends AppCompatImageView {
    ...
    public UIRadiusImageView(Context context) {
        this(context, null, R.attr.UIRadiusImageViewStyle);
    }

    public UIRadiusImageView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.UIRadiusImageViewStyle);
    }

    public UIRadiusImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(
                attrs, R.styleable.UIRadiusImageView, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.UIRadiusImageView_ui_border_width, 0);
        mBorderColor = array.getColor(R.styleable.UIRadiusImageView_ui_border_color, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.UIRadiusImageView_ui_selected_border_width, mBorderWidth);
        mSelectedBorderColor = array.getColor(
                R.styleable.UIRadiusImageView_ui_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(
                R.styleable.UIRadiusImageView_ui_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(
                R.styleable.UIRadiusImageView_ui_is_touch_select_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.UIRadiusImageView_ui_is_circle, false);
        if (!mIsCircle) {
            mIsOval = array.getBoolean(R.styleable.UIRadiusImageView_ui_is_oval, false);
        }
        if (!mIsOval) {
            mCornerRadius = array.getDimensionPixelSize(
                    R.styleable.UIRadiusImageView_ui_corner_radius, 0);
        }
        array.recycle();
    }
