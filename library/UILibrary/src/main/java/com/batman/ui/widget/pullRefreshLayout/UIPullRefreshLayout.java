...
package com.batman.ui.widget.pullRefreshLayout;
...
import com.batman.ui.nestedScroll.UIContinuousNestedScrollLayout;
 ...
 * <li>可在 xml 中使用 {@link com.batman.ui.R.styleable#UIPullRefreshLayout} 这些属性或在 Java 设置对应的属性决定子View的开始位置、触发刷新的位置等值</li>
 * </ul>
 *
 * @author cginechen
 * @date 2016-12-11
...
public class UIPullRefreshLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public static boolean defaultCanScrollUp(View view) {
        ...
        if (view instanceof UIContinuousNestedScrollLayout) {
            UIContinuousNestedScrollLayout layout = (UIContinuousNestedScrollLayout) view;
            return layout.getCurrentScroll() > 0;
        }

        if (view instanceof UIStickySectionLayout) {
            UIStickySectionLayout layout = (UIStickySectionLayout) view;
    ...
    public static class RefreshView extends AppCompatImageView implements IRefreshView, IUISkinDefaultAttrProvider {
