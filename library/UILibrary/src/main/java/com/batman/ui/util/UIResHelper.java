...
public class UIResHelper {
    ...
    public static Drawable getAttrDrawable(Context context, Resources.Theme theme, int attr) {
        ...
        if (sTmpValue.resourceId != 0) {
            return UIDrawableHelper.getVectorDrawable(context, sTmpValue.resourceId);
        }
        return null;
    }
    ...
    public static int getAttrDimen(Context context, int attrRes) {
        ...
        return TypedValue.complexToDimensionPixelSize(sTmpValue.data, UIDisplayHelper.getDisplayMetrics(context));
    }
