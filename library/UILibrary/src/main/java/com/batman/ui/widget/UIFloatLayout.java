 ...
 * </ul>
 * <p>在 xml 中采用 {@link com.batman.ui.R.styleable#UIFloatLayout} 控制以上属性。</p>
 */
public class UIFloatLayout extends ViewGroup {
    ...
    public UIFloatLayout(Context context) {
        this(context, null);
    }

    public UIFloatLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UIFloatLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.UIFloatLayout);
        mChildHorizontalSpacing = array.getDimensionPixelSize(
                R.styleable.UIFloatLayout_ui_childHorizontalSpacing, 0);
        mChildVerticalSpacing = array.getDimensionPixelSize(
                R.styleable.UIFloatLayout_ui_childVerticalSpacing, 0);
        mGravity = array.getInteger(R.styleable.UIFloatLayout_android_gravity, Gravity.LEFT);
        int maxLines = array.getInt(R.styleable.UIFloatLayout_android_maxLines, -1);
        if (maxLines >= 0) {
            setMaxLines(maxLines);
        }
        int maxNumber = array.getInt(R.styleable.UIFloatLayout_ui_maxNumber, -1);
        if (maxNumber >= 0) {
