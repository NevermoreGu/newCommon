...
/**
 * 在 {@link UIBasicTabSegment} 的基础上添加与 {@link ViewPager} 的联动使用
 */
public class UITabSegment extends UIBasicTabSegment {
    ...
    /**
     * Please use UIBasicTabSegment.OnTabClickListener for a replacement
     */
    @Deprecated
    public interface OnTabClickListener extends UIBasicTabSegment.OnTabClickListener{

    }

    /**
     * Please use UIBasicTabSegment.OnTabSelectedListener for a replacement
     */
    @Deprecated
    public interface OnTabSelectedListener extends UIBasicTabSegment.OnTabSelectedListener{
