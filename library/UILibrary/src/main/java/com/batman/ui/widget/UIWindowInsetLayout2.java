...
import com.batman.ui.util.UIWindowInsetHelper;
 ...
 * 当windowInsets.bottom > 100dp的时候，我们认为是弹起了键盘。一旦弹起键盘，那么将由UIWindowInsetLayout消耗掉，其子view的windowInsets.bottom传递为0
 *
 * @author cginechen
 * @date 2016-03-25
 */
public class UIWindowInsetLayout2 extends UIConstraintLayout implements IWindowInsetLayout {
    protected UIWindowInsetHelper mUIWindowInsetHelper;

    public UIWindowInsetLayout2(Context context) {
        this(context, null);
    }

    public UIWindowInsetLayout2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UIWindowInsetLayout2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mUIWindowInsetHelper = new UIWindowInsetHelper(this, this);
    }
    ...
    public boolean applySystemWindowInsets19(Rect insets) {
        return mUIWindowInsetHelper.defaultApplySystemWindowInsets19(this, insets);
    }

    @Override
    public boolean applySystemWindowInsets21(Object insets) {
        return mUIWindowInsetHelper.defaultApplySystemWindowInsets21(this, insets);
    }
