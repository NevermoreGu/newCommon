...
public class UITabIcon extends Drawable implements Drawable.Callback {
    ...
    public UITabIcon(@NonNull Drawable normalIconDrawable, @Nullable Drawable selectedIconDrawable){
        this(normalIconDrawable, selectedIconDrawable, true);
    }
    public UITabIcon(@NonNull Drawable normalIconDrawable, @Nullable Drawable selectedIconDrawable, boolean dynamicChangeIconColor) {
    ...
    public void tint(int normalColor, int selectColor) {
        if (mSelectedIconDrawable == null) {
            DrawableCompat.setTint(mNormalIconDrawable, UIColorHelper.computeColor(normalColor, selectColor, mCurrentSelectFraction));
        } else {
    ...
    /**
     * set the select faction for UITabIcon, value must be in [0, 1]
     *
