...
import com.batman.ui.skin.annotation.UISkinChangeNotAdapted;
 ...
 * </p>
 */
public class UIEmptyView extends ConstraintLayout {
    ...
    public UIEmptyView(Context context, AttributeSet attrs, int defStyle) {
        ...
        init();
        TypedArray arr = context.obtainStyledAttributes(attrs, R.styleable.UIEmptyView);
        boolean attrShowLoading = arr.getBoolean(R.styleable.UIEmptyView_ui_show_loading, false);
        String attrTitleText = arr.getString(R.styleable.UIEmptyView_ui_title_text);
        String attrDetailText = arr.getString(R.styleable.UIEmptyView_ui_detail_text);
        String attrBtnText = arr.getString(R.styleable.UIEmptyView_ui_btn_text);
        arr.recycle();
        show(attrShowLoading, attrTitleText, attrDetailText, attrBtnText, null);
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.ui_empty_view, this, true);
    ...
    public void setTitleSkinValue(UISkinValueBuilder builder) {
        UISkinHelper.setSkinValue(mTitleTextView, builder);
    }

    public void setDetailSkinValue(UISkinValueBuilder builder) {
        UISkinHelper.setSkinValue(mDetailTextView, builder);
    }

    public void setLoadingSkinValue(UISkinValueBuilder builder) {
        UISkinHelper.setSkinValue(mLoadingView, builder);
    }

    public void setBtnSkinValue(UISkinValueBuilder builder) {
        UISkinHelper.setSkinValue(mButton, builder);
    }
