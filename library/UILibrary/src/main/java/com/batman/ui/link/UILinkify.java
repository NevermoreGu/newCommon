...
public class UILinkify {
    ...
    public static final WebUrlMatcher UI_WEB_URL_MATCHER = new WebUrlMatcher() {
        @Override
    ...
    public static void useQmuiWebUrlMatcher(){
        sWebUrlMatcher = UI_WEB_URL_MATCHER;
    }
     ...
     */
    public static boolean addLinks(Spannable text, int mask, ColorStateList linkColor, ColorStateList bgColor, UIOnSpanClickListener l) {
        if (mask == 0) {
            return false;
        }
     ...
     * LinkMovementMethod.
     */
    public static boolean addLinks(TextView text, int mask, ColorStateList linkColor, ColorStateList bgColor, UIOnSpanClickListener l) {
        if (mask == 0) {
            return false;
        }
    ...
    private static void applyLink(String url, int start, int end, Spannable text, final ColorStateList linkColor, final ColorStateList bgColor, UIOnSpanClickListener l) {
    ...
    private static abstract class StyleableURLSpan extends URLSpan implements ITouchableSpan {
        ...
        protected UIOnSpanClickListener mOnSpanClickListener;

        public StyleableURLSpan(String url, UIOnSpanClickListener l) {
            super(url);
            mUrl = url;
