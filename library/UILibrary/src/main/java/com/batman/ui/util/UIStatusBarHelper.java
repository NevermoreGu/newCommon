...
public class UIStatusBarHelper {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(UIDeviceHelper.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (UIDeviceHelper.isFlymeLowerThan(8) || (UIDeviceHelper.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//            }
    ...
    private static boolean Android6SetStatusBarLightMode(Window window, boolean light) {
        ...
        if (UIDeviceHelper.isMIUIV9()) {
            // MIUI 9 低于 6.0 版本依旧只能回退到以前的方案
            // https://github.com/Tencent/UI_Android/issues/160
    ...
    public static boolean FlymeSetStatusBarLightMode(Window window, boolean light) {
        ...
        if (window != null) {
            ...
            if(UIDeviceHelper.isFlymeLowerThan(7)){
                try {
            ...
            }else if(UIDeviceHelper.isFlyme()){
                result = true;
            }
        }
        return result;
