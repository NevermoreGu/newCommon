...
public class UIPriorityLinearLayout extends UILinearLayout {
    ...
    public UIPriorityLinearLayout(Context context) {
        super(context);
    }

    public UIPriorityLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            final TypedArray a = c.obtainStyledAttributes(attrs,
                    R.styleable.UIPriorityLinearLayout_Layout);
            priority = a.getInteger(R.styleable.UIPriorityLinearLayout_Layout_ui_layout_priority,
                    PRIORITY_MINI_CONTENT_PROTECTION);
            miniContentProtectionSize = a.getDimensionPixelSize(
                    R.styleable.UIPriorityLinearLayout_Layout_ui_layout_miniContentProtectionSize,
                    0);
            a.recycle();
        }
