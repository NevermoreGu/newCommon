...
import com.batman.ui.alpha.UIAlphaViewHelper;
...
/**
 * shown image in radius view, is different to {@link UIRadiusImageView}
 * the oval is not supported
 */
public class UIRadiusImageView2 extends AppCompatImageView implements IUILayout {
    ...
    public UIRadiusImageView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public UIRadiusImageView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(
                attrs, R.styleable.UIRadiusImageView2, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.UIRadiusImageView2_ui_border_width, 0);
        mBorderColor = array.getColor(R.styleable.UIRadiusImageView2_ui_border_color, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.UIRadiusImageView2_ui_selected_border_width, mBorderWidth);
        mSelectedBorderColor = array.getColor(
                R.styleable.UIRadiusImageView2_ui_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(
                R.styleable.UIRadiusImageView2_ui_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(
                R.styleable.UIRadiusImageView2_ui_is_touch_select_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.UIRadiusImageView2_ui_is_circle, false);
        if (!mIsCircle) {
            setRadius(array.getDimensionPixelSize(
                    R.styleable.UIRadiusImageView2_ui_corner_radius, 0));
        }
        array.recycle();
    }
