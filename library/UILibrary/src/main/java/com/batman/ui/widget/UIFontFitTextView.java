 ...
 */
public class UIFontFitTextView extends AppCompatTextView {
    ...
    public UIFontFitTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.UIFontFitTextView);
        minSize = array.getDimensionPixelSize(
                R.styleable.UIFontFitTextView_ui_minTextSize, Math.round(14 * UIDisplayHelper.DENSITY));
        maxSize = array.getDimensionPixelSize(
                R.styleable.UIFontFitTextView_ui_maxTextSize, Math.round(18 * UIDisplayHelper.DENSITY));
        array.recycle();
