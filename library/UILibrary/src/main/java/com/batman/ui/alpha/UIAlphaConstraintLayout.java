 ...
 */
public class UIAlphaConstraintLayout extends ConstraintLayout implements UIAlphaViewInf {
    ...
    public UIAlphaConstraintLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public UIAlphaConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
