...
import com.batman.ui.util.UIDeviceHelper;
 ...
 * @date 2016-02-17
 */
public class UIBlockSpaceSpan extends ReplacementSpan {
    private int mHeight;

    public UIBlockSpaceSpan(int height) {
        mHeight = height;
    }

    @Override
    public int getSize(@NonNull Paint paint, CharSequence text, int start, int end, Paint.FontMetricsInt fm) {
        if (fm != null && !UIDeviceHelper.isMeizu()) {
