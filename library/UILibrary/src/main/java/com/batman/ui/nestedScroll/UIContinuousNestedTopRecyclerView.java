...
public class UIContinuousNestedTopRecyclerView extends RecyclerView implements IUIContinuousNestedTopView {
    public static final String KEY_SCROLL_INFO_POSITION = "@ui_scroll_info_top_rv_pos";
    public static final String KEY_SCROLL_INFO_OFFSET = "@ui_scroll_info_top_rv_offset";

    private OnScrollNotifier mScrollNotifier;
    private final int[] mScrollConsumed = new int[2];

    public UIContinuousNestedTopRecyclerView(@NonNull Context context) {
        this(context, null);
        init();
    }

    public UIContinuousNestedTopRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
        init();
    }

    public UIContinuousNestedTopRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
