 ...
 * @date 2016-03-25
 */
public class UIWindowInsetLayout extends UIFrameLayout implements IWindowInsetLayout {
    ...
    public UIWindowInsetLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UIWindowInsetLayout(Context context, AttributeSet attrs, int defStyleAttr) {
