...
import com.batman.ui.skin.IUISkinHandlerDecoration;
...
import com.batman.ui.widget.section.UIStickySectionLayout;


public class UIRVDraggableScrollBar extends RecyclerView.ItemDecoration implements IUISkinHandlerDecoration, UIStickySectionLayout.DrawDecoration {
    ...
    UIStickySectionLayout mStickySectionLayout;
    ...
    public UIRVDraggableScrollBar(int startMargin,
                                    int endMargin,
                                    int inwardOffset,
    ...
    public void setScrollBarDrawable(@Nullable Drawable scrollBarDrawable) {
        ...
        if (mRecyclerView != null) {
            UISkinHelper.refreshRVItemDecoration(mRecyclerView, this);
        }
        invalidate();
    }
    ...
    private void commonAttachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (recyclerView != null) {
            setupCallbacks();
            UISkinHelper.refreshRVItemDecoration(recyclerView, this);
        }
    }
    ...
    public void attachToStickSectionLayout(@Nullable UIStickySectionLayout stickySectionLayout) {
    ...
    private void onDragging(RecyclerView recyclerView, Drawable drawable, int x, int y) {
        ...
        percent = UILangHelper.constrain(percent, 0f, 1f);
        if (mCallback != null) {
    ...
    @Override
    public void onDraw(@NonNull Canvas c, @NonNull UIStickySectionLayout parent) {

    }

    @Override
    public void onDrawOver(@NonNull Canvas c, @NonNull UIStickySectionLayout parent) {
        if (mRecyclerView != null) {
    ...
    private float calculatePercent(@NonNull RecyclerView recyclerView) {
        return UILangHelper.constrain(getCurrentOffset(recyclerView) * 1f / getScrollRange(recyclerView), 0f, 1f);
    }

    public Drawable ensureScrollBar(Context context) {
        if (mScrollBarDrawable == null) {
            setScrollBarDrawable(
                    ContextCompat.getDrawable(context, R.drawable.ui_icon_scroll_bar));
        }
    ...
    public void handle(@NonNull RecyclerView recyclerView,
                       @NonNull UISkinManager manager,
                       int skinIndex,
                       @NonNull Resources.Theme theme) {
        if (mScrollBarSkinRes != 0) {
            mScrollBarDrawable = UIResHelper.getAttrDrawable(
            ...
            DrawableCompat.setTintList(mScrollBarDrawable,
                    UIResHelper.getAttrColorStateList(
