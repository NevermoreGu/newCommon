...
/**
 * 在 {@link UIBasicTabSegment} 的基础上添加与 {@link ViewPager2} 的联动使用
 */
public class UITabSegment2 extends UIBasicTabSegment {
    ...
    public UITabSegment2(Context context) {
        super(context);
    }

    public UITabSegment2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public UITabSegment2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * associate UITabSegment2 with a {@link ViewPager2}
     *
    ...
    public static class TabLayoutOnPageChangeListener extends ViewPager2.OnPageChangeCallback {
        private final WeakReference<UITabSegment2> mTabSegmentRef;

        public TabLayoutOnPageChangeListener(UITabSegment2 tabSegment) {
            mTabSegmentRef = new WeakReference<>(tabSegment);
        }

        @Override
        public void onPageScrollStateChanged(final int state) {
            final UITabSegment2 tabSegment = mTabSegmentRef.get();
            if (tabSegment != null) {
