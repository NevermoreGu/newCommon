...
public class UIProgressBar extends View {
    ...
    private Runnable mNotifyProgressChangeAction = new Runnable() {
        ...
        public void run() {
            if(mOnProgressChangeListener != null){
                mOnProgressChangeListener.onProgressChange(UIProgressBar.this, mValue, mMaxValue);
            }
        }
    };
    ...
    public interface OnProgressChangeListener {
        void onProgressChange(UIProgressBar progressBar, int currentValue, int maxValue);
    }
}
