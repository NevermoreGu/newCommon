...
public class UIContinuousNestedTopDelegateLayout extends FrameLayout implements
        NestedScrollingChild2, NestedScrollingParent2, IUIContinuousNestedTopView {

    public static final String KEY_SCROLL_INFO_OFFSET = "@ui_scroll_info_top_dl_offset";

    private OnScrollNotifier mScrollNotifier;
    private View mHeaderView;
    private IUIContinuousNestedTopView mDelegateView;
    private View mFooterView;
    private UIViewOffsetHelper mHeaderViewOffsetHelper;
    private UIViewOffsetHelper mDelegateViewOffsetHelper;
    private UIViewOffsetHelper mFooterViewOffsetHelper;
    ...
    public UIContinuousNestedTopDelegateLayout(@NonNull Context context) {
        this(context, null);
    }

    public UIContinuousNestedTopDelegateLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public void setHeaderView(@NonNull View headerView) {
        ...
        mHeaderViewOffsetHelper = new UIViewOffsetHelper(headerView);
        addView(headerView, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
    }

    public void setDelegateView(@NonNull IUIContinuousNestedTopView delegateView) {
        ...
        mDelegateViewOffsetHelper = new UIViewOffsetHelper(view);
        // WRAP_CONTENT, the height will be handled by UIContinuousNestedTopAreaBehavior
    ...
    public void setFooterView(@NonNull View footerView) {
        ...
        mFooterViewOffsetHelper = new UIViewOffsetHelper(footerView);
    ...
    public IUIContinuousNestedTopView getDelegateView() {
    ...
    public void restoreScrollInfo(@NonNull Bundle bundle) {
        ...
        offsetTo(UILangHelper.constrain(-offset, 0, getContainerOffsetRange()));
        if (mDelegateView != null) {
