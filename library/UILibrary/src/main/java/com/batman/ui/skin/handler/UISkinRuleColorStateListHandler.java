...
public abstract class UISkinRuleColorStateListHandler implements IUISkinRuleHandler {
    @Override
    public final void handle(@NonNull UISkinManager skinManager, @NonNull View view, @NonNull Resources.Theme theme,
        ...
        handle(view, name, UIResHelper.getAttrColorStateList(view.getContext(), theme, attr));
    }
