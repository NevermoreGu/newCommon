...
import com.batman.ui.span.UIAlignMiddleImageSpan;
import com.batman.ui.span.UIMarginImageSpan;
...
public class UISpanHelper {
    ...
    public static CharSequence generateHorIconText(CharSequence text,
        ...
        if (iconLeft != null) {
            ...
            UIMarginImageSpan imageSpan = new UIMarginImageSpan(iconLeft,
                    UIAlignMiddleImageSpan.ALIGN_MIDDLE, 0, leftPadding, iconOffsetY);
        ...
        if (iconRight != null) {
            ...
            UIMarginImageSpan imageSpan = new UIMarginImageSpan(iconRight,
                    UIAlignMiddleImageSpan.ALIGN_MIDDLE, rightPadding, 0, iconOffsetY);
