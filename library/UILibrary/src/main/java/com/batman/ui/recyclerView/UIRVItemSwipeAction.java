...
package com.batman.ui.recyclerView;
...
public class UIRVItemSwipeAction extends RecyclerView.ItemDecoration
    ...
    private static final String TAG = "UIRVItemSwipeAction";
        ...
        public boolean onInterceptTouchEvent(@NonNull RecyclerView recyclerView,
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                if (mSelected == null) {
                    ...
                    if (mSelected instanceof UISwipeViewHolder) {
                        UISwipeViewHolder swipeViewHolder = (UISwipeViewHolder) mSelected;
    ...
    public UIRVItemSwipeAction(boolean swipeDeleteWhenOnlyOneAction, Callback callback) {
        mCallback = callback;
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (recyclerView != null) {
            ...
            mSwipeEscapeVelocity = resources.getDimension(R.dimen.ui_rv_swipe_action_escape_velocity);
            mMaxSwipeVelocity = resources.getDimension(R.dimen.ui_rv_swipe_action_escape_max_velocity);
            setupCallbacks();
        }
    }
    ...
    void handleSwipeActionActionUp( UISwipeViewHolder swipeViewHolder, float x, float y, int touchSlop){
        UISwipeAction action = swipeViewHolder.checkUp(x, y, touchSlop);
        if (action != null) {
    ...
    void select(@Nullable RecyclerView.ViewHolder selected, boolean isActionUp) {
        ...
        if (selected != null) {
            ...
            mSelected = selected;
            if (selected instanceof UISwipeViewHolder) {
                UISwipeViewHolder uiSwipeViewHolder = (UISwipeViewHolder) selected;
                uiSwipeViewHolder.setup(mSwipeDirection, mSwipeDeleteWhenOnlyOneAction);
            }
        }
    ...
    private int checkSwipe(RecyclerView.ViewHolder viewHolder, int swipeDirection, boolean checkAction) {
        if (swipeDirection == SWIPE_LEFT || swipeDirection == SWIPE_RIGHT) {
            ...
            float threshold;
            if (checkAction && viewHolder instanceof UISwipeViewHolder) {
                threshold = ((UISwipeViewHolder) viewHolder).mActionTotalWidth;
            } else {
            ...
            float threshold;
            if (checkAction && viewHolder instanceof UISwipeViewHolder) {
                threshold = ((UISwipeViewHolder) viewHolder).mActionTotalHeight;
            } else {
    ...
    public static abstract class Callback {
        ...
        public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
            ...
            if (viewHolder instanceof UISwipeViewHolder) {
                ((UISwipeViewHolder) viewHolder).clearTouchInfo();
            }
        }
        ...
        public void onClickAction(UIRVItemSwipeAction swipeAction, RecyclerView.ViewHolder selected, UISwipeAction action) {
        ...
        public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView,
            ...
            if (viewHolder instanceof UISwipeViewHolder) {
                if (swipeDirection != SWIPE_NONE) {
                    ((UISwipeViewHolder) viewHolder).draw(c, isOverThreshold(recyclerView, viewHolder, dX, dY, swipeDirection), dX, dY);
                }
            }
        }
    }
