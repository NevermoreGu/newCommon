 ...
 * </p>
 * <p>
 * 如需在 xml 中指定圆角、边框颜色、边框粗细、背景色等值,采用 xml 属性 {@link com.batman.ui.R.styleable#UIRoundButton}
 * </p>
 * <p>
...
public class UIRoundButton extends UIAlphaButton implements IUISkinDefaultAttrProvider {
    ...
    static {
        ...
        sDefaultSkinAttrs.put(UISkinValueBuilder.BACKGROUND, R.attr.ui_skin_support_round_btn_bg_color);
        sDefaultSkinAttrs.put(UISkinValueBuilder.BORDER, R.attr.ui_skin_support_round_btn_border_color);
        sDefaultSkinAttrs.put(UISkinValueBuilder.TEXT_COLOR, R.attr.ui_skin_support_round_btn_text_color);
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mRoundBg = UIRoundButtonDrawable.fromAttributeSet(context, attrs, defStyleAttr);
        UIViewHelper.setBackgroundKeepingPadding(this, mRoundBg);
