...
public class UICustomTypefaceSpan extends TypefaceSpan {
    ...
    public static final Creator<UICustomTypefaceSpan> CREATOR = new Creator<UICustomTypefaceSpan>() {
        @Override
        public UICustomTypefaceSpan createFromParcel(Parcel source) {
            return null;
        }

        @Override
        public UICustomTypefaceSpan[] newArray(int size) {
            return new UICustomTypefaceSpan[size];
        }
    };
     ...
     */
    public UICustomTypefaceSpan(String family, @Nullable Typeface type) {
        super(family);
        newType = type;
    }
