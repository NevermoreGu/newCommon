...
public class UIStickySectionLayout extends UIFrameLayout implements UIStickySectionAdapter.ViewCallback {

    private RecyclerView mRecyclerView;
    private UIFrameLayout mStickySectionWrapView;
    private UIStickySectionItemDecoration mStickySectionItemDecoration;
    ...
    public UIStickySectionLayout(Context context) {
        this(context, null);
    }

    public UIStickySectionLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UIStickySectionLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mStickySectionWrapView = new UIFrameLayout(context);
    ...
    public UIFrameLayout getStickySectionWrapView() {
    ...
    /**
     * section header will be sticky when scrolling, see {@link #setAdapter(UIStickySectionAdapter, boolean)}
     *
     * @param adapter the adapter inherited from UIStickySectionAdapter
     * @param <H>     generic parameter of UIStickySectionAdapter, indicating the section header
     * @param <T>     generic parameter of UIStickySectionAdapter, indicating the section item
     * @param <VH>    generic parameter of UIStickySectionAdapter, indicating the view holder
     */
    public <H extends UISection.Model<H>,
            T extends UISection.Model<T>,
            VH extends UIStickySectionAdapter.ViewHolder> void setAdapter(
            UIStickySectionAdapter<H, T, VH> adapter) {
    ...
    public <H extends UISection.Model<H>,
            T extends UISection.Model<T>,
            VH extends UIStickySectionAdapter.ViewHolder> void setAdapter(
            final UIStickySectionAdapter<H, T, VH> adapter, boolean sticky) {
        if (sticky) {
            UIStickySectionItemDecoration.Callback<VH> callback = new UIStickySectionItemDecoration.Callback<VH>() {
                @Override
                ...
                public boolean isHeaderItem(int pos) {
                    return adapter.getItemViewType(pos) == UIStickySectionAdapter.ITEM_TYPE_SECTION_HEADER;
                }
            ...
            mStickySectionItemDecoration = new UIStickySectionItemDecoration<>(mStickySectionWrapView, callback);
    ...
    public interface StickySectionWrapViewConfig {
        void config(UIFrameLayout stickySectionWrapView);
    }
    ...
    public interface DrawDecoration {
        void onDraw(@NonNull Canvas c, @NonNull UIStickySectionLayout parent);
        void onDrawOver(@NonNull Canvas c, @NonNull UIStickySectionLayout parent);
    }
}
