...
public abstract class UIDefaultStickySectionAdapter<
        H extends UISection.Model<H>,
        T extends UISection.Model<T>> extends
        UIStickySectionAdapter<H, T, UIStickySectionAdapter.ViewHolder> {
